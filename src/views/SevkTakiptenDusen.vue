<template>
  ...
  <div class="grid">
    <div class="col">
      <DataTable :value="takip_listesi" v-model:filters="filters" filterDisplay="row" dataKey="id" sortField="kalan_alacak"
        ...
        <Column field="sevk_tarihi" header="Sevk Tarihi" headerStyle="width:8px" :showFilterMenu="false">
          <template #body="slotProps">
        ...
        <Column field="konteynerno" header="Konteynır No" headerStyle="width:15px" :showFilterMenu="false">
          <template #body="slotProps">
        ...
        <Column field="konsimento" header="Konşimento" headerStyle="width:8px">
          <template #body="slotProps">
        ...
        <Column field="sorumlusu" header="Sorumlusu" headerStyle="width:7px" bodyStyle="text-align:center;">
          <template #body="slotProps">
  ...
  <Dialog v-model:visible="is_takipform" :header="takip_form_baslik" :modal="true" position="top">
